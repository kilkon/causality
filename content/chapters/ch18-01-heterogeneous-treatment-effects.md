...
# 16.1 CATE의 정의와 식별평균 처치효과 \(ATE\)는 정책의 전반적 방향을 보여주지만, 실제 정책은 거의 항상 사람마다 다르게 작동한다. 어떤 집단에는 매우 효과적이고, 다른 집단에는 거의 무효이거나 부정적일 수 있다. CATE는 바로 이런 **이질적 처치효과(heterogeneous treatment effects)**를 다루는 핵심 개념이다.
